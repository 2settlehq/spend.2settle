...
const ChatInput = ({ textareaRef, chatInput, onChange, onSubmit }: Props) => {
  ...
  return (
    <footer className="flex-shrink-0 border-t border-gray-200 bg-white px-5 py-4 sm:px-7 sm:py-5">
      <div className="flex min-h-12 items-center gap-3">
        <textarea
          ...
          className="max-h-28 min-h-10 flex-grow resize-none border-none bg-transparent px-0 py-2 text-base leading-6 outline-none"
