...
import { amlKycParagraphs, type AmlKycParagraph } from "@/content/aml-kyc";
...
const firstSectionIndex = amlKycParagraphs.findIndex((item) => item.style === "HEADING_2");
const introduction = amlKycParagraphs.slice(2, firstSectionIndex);

function buildSections(paragraphs: AmlKycParagraph[]): PolicySection[] {
...
const sections = buildSections(amlKycParagraphs.slice(firstSectionIndex));
...
export default function AmlKycPolicy() {
  return (
    <>
      <Head>
        <title>AML/KYC Policy | 2Settle</title>
        <meta name="description" content="2Settle AML/KYC Policy covering customer identification, business verification and transaction monitoring." />
      </Head>
      <Layout>
